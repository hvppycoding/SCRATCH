...
class FilesystemTools:
    ...
    async def read_media_file(self, path: str) -> Dict[str, str]:
        ...
        Returns:
            Dictionary containing 'type' (image/audio/blob), 'data' (base64), and 'mimeType'.
        """
        valid_path = await self._validate_path(path)
    ...
    def to_openai_tools(self) -> List[Dict[str, Any]]:
        ...
        In Strict Mode:
        - All properties must be in 'required' list.
        - Optional parameters must have type ["type", "null"].
        ...
        tools = [
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Read an image or audio file (Base64).",
                    "strict": True,
                    "parameters": {
                        "type": "object",
                        "properties": {
            ...
            },
            {
                ...
                "function": {
                    "name": "write_file",
                    "description": "Write to a file (Atomic).",
                    "strict": True,
                    "parameters": {
                        "type": "object",
                        "properties": {
            ...
            },
            {
                ...
                "function": {
                    "name": "edit_file",
                    "description": "Apply line-based edits to a text file.",
                    "strict": True,
                    "parameters": {
                        "type": "object",
                        "properties": {
